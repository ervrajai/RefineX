...
EMAIL_PORT = int(str(os.getenv("EMAIL_PORT", "587")).strip().strip("'\""))
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER", "refinexteam@gmail.com").strip().strip("'\"")
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD", "apbmgkakcgclllqv").strip().strip("'\"")
EMAIL_USE_TLS = os.getenv("EMAIL_USE_TLS", "True").lower().strip() in ("true", "1", "yes")
EMAIL_USE_SSL = os.getenv("EMAIL_USE_SSL", "False").lower().strip() in ("true", "1", "yes")
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "refinexteam@gmail.com").strip().strip("'\"")
EMAIL_TIMEOUT = int(str(os.getenv("EMAIL_TIMEOUT", "20")).strip())
