...
function SettingsView({ user, loading }) {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-2xl mx-auto font-sans select-none animate-fade-in text-slate-900 dark:text-white">
      
      {/* Profile Card */}
      <div className="relative flex flex-col justify-between w-full p-6 sm:p-8 overflow-hidden rounded-2xl bg-gradient-to-r from-[#5936B4] to-[#362A84] border border-black dark:border-white shrink-0 group transition-colors duration-300 gap-6">
        ...
        <div className="flex items-center justify-between w-full z-10">
          ...
          <button 
            title="Edit Profile" 
            className="flex items-center justify-center p-2.5 rounded-xl bg-white/10 border border-white/30 text-white transition-colors duration-200 hover:bg-white/20 hover:border-white shrink-0"
          >
      ...
      <div className="flex flex-col p-5 sm:p-7 rounded-2xl bg-white dark:bg-[#121212] border border-black dark:border-white transition-colors duration-300">
          ...
          {[
            ...
            return (
              <button
                ...
                className={`relative flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg text-sm font-bold transition-colors duration-300 outline-none select-none ${
                  isSelected
              ...
              >
                ...
                {isSelected && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-white dark:bg-zinc-800 border border-black dark:border-white rounded-lg shadow-sm"
                    initial={false}
