...
function Dashboard() {
  ...
  return (
    <div className="flex w-screen h-screen bg-[#FFFFFF] dark:bg-[#0F0F0F] text-slate-900 dark:text-white transition-colors duration-300 overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        ...
        <div className={`absolute top-4 right-6 z-40 transition-all duration-300 ${
          ...
          <button className="relative p-2.5 rounded-xl text-slate-500 dark:text-zinc-400 bg-[#F2F2F2]/80 dark:bg-[#212121]/80 border border-slate-200/50 dark:border-zinc-800 backdrop-blur shadow-sm hover:bg-[#E5E5E5] dark:hover:bg-[#272727] hover:text-slate-900 dark:hover:text-white transition duration-200 cursor-pointer">
